declare module '@themes/cli/colors' {
  ...
  export type ColorRole =
    ...
    | 'error'
    | 'info'
  export const colorSteps: readonly [
    'base',
    'bgSubtle',
    'bg',
    'bgHover',
...
declare module '@themes/cli/modular-scale' {
...
declare module '@themes/cli/theme' {
  import { ColorRole, ColorStep } from '@themes/cli/colors'
  import { ModularScaleOptions } from '@themes/cli/modular-scale'
